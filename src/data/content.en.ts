...
export const content = {
  home: {
    seoTitle: 'Home',
    eyebrow: 'WM · Home and energy',
    introTitle: 'Everyday life deserves good design.',
    introBody: 'From your first recipe of the day to the energy you need. Discover products made to be part of your life, with functionality, design and WM support.',
    homeLabel: '01 / Home',
    homeTitle: 'Your kitchen. Your ideas. More possibilities.',
    homeBody: 'Blend, prepare and share. Find appliances that fit the way you cook and products for the spaces you enjoy every day.',
    homeCta: 'Explore home',
    energyLabel: '02 / Energy',
    energyTitle: 'Energy to keep your day going.',
    energyBody: 'Meet the P3200 portable power station. Explore its connections, capacity and specifications to find the backup you need.',
    energyCta: 'Explore energy',
    selectionLabel: 'The WM selection',
    brandCta: 'Discover our brand',
    productCta: 'Discover product',
    supportLabel: 'Here to help you',
  },
  hero: {
  ...
  productDetail: {
    ...
    galleryLoadError: 'That image could not be loaded. Select it again to retry.',
    zoomAriaLabel: 'View image full screen',
    closeZoomAriaLabel: 'Close full screen view',
