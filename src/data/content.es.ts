...
export const content = {
  home: {
    seoTitle: 'Inicio',
    eyebrow: 'WM · Hogar y energía',
    introTitle: 'Lo cotidiano merece un buen diseño.',
    introBody: 'Desde la primera receta del día hasta la energía que necesitas. Descubre productos pensados para acompañarte, con funcionalidad, diseño y el respaldo de WM.',
    homeLabel: '01 / Hogar',
    homeTitle: 'Tu cocina. Tus ideas. Más posibilidades.',
    homeBody: 'Mezclar, preparar y compartir. Encuentra electrodomésticos que se adaptan a tu manera de cocinar y productos para los espacios que disfrutas cada día.',
    homeCta: 'Explorar hogar',
    energyLabel: '02 / Energía',
    energyTitle: 'Energía para seguir con tu día.',
    energyBody: 'Conoce la estación de energía portátil P3200. Explora sus conexiones, capacidad y especificaciones para encontrar el respaldo que necesitas.',
    energyCta: 'Explorar energía',
    selectionLabel: 'La selección WM',
    brandCta: 'Conoce nuestra marca',
    productCta: 'Descubrir producto',
    supportLabel: 'Estamos para acompañarte',
  },
  hero: {
  ...
  productDetail: {
    ...
    galleryLoadError: 'No se pudo cargar esa imagen. Vuelve a seleccionarla para intentar de nuevo.',
